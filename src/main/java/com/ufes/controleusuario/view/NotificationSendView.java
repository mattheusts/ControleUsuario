...
/**
 * NotificationSendView - JInternalFrame para envio de notificações
 * Padrão MVP - Passive View
 */
public class NotificationSendView extends JInternalFrame {
    ...
    // Store user IDs corresponding to list items
    ...
    private void initComponents() {
        ...
        // Add listeners for count updates
