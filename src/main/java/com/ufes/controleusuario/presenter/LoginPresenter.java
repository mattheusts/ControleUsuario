...
public class LoginPresenter {
  ...
  private void onRegister(ActionEvent e) {
    com.ufes.controleusuario.view.UserRegistrationView regView = new com.ufes.controleusuario.view.UserRegistrationView(
        view);
    com.ufes.controleusuario.service.IPasswordValidator validator = new com.ufes.controleusuario.infra.PasswordValidatorAdapter();
    new com.ufes.controleusuario.presenter.UserRegistrationPresenter(regView, userRepository, logger, validator);
